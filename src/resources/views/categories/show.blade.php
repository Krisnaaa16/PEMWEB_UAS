                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('categories.index') }}" class="ml-1 text-gray-700 hover:text-green-600 md:ml-2">Kategori</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
        ...
        <div class="lg:grid lg:grid-cols-4 lg:gap-8">
            ...
            <div class="hidden lg:block">
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <form method="GET" action="{{ route('categories.show', $category) }}">
                        ...
                        @if(request()->hasAny(['search', 'min_price', 'max_price', 'condition', 'available_only']))
            ...
            <div class="lg:col-span-3">
                ...
                <div class="bg-white rounded-lg shadow p-4 mb-6">
                    <form method="GET" action="{{ route('categories.show', $category) }}" class="flex items-center justify-between">
